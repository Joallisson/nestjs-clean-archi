...
describe('UsersController e2e tests', () => {
  ...
  beforeEach(async () => {
    ...
    describe('PATCH /users', () => {
      ...
      it('should return a error 422 code when the request body is invalid', async () => {
        const res = await request(app.getHttpServer())
        .patch(`/users/fakeId`)
        .set('Authorization', `Bearer ${accessToken}`)
        .send({})
      ...
      it('should return a error 422 code when the password field is invalid', async () => {
      ...
      it('should return a error 422 code when the oldPassword field is invalid', async () => {
      ...
      it('should return a error 422 code when password does not match', async () => {
      ...
      it('should return a error 401 code when the request is not authorized', async () => {
