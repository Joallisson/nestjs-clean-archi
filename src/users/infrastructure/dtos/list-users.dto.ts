...
export class ListUsersDto implements ListUsersUseCase.Input {
  ...
  @ApiPropertyOptional({ description: 'Quantidade de registros por página: "name" ou "createdAt"'})
  @IsOptional()
  sort?: string

  @ApiPropertyOptional({ description: 'Ordenação dos dados crescente ou decrescente: "asc" ou "desc"'})
  @IsOptional()
